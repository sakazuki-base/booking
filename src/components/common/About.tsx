  ...
  return (
    ...
    <div>
      ...
      <ol>
        ...
        <li>
          登録後、スケジュールと上部のタイムテーブルに反映されているかを確認
        </li>
      ...
      <div>
        ...
        <dl>
          <div>
            ...
            <dd>
              予約終了時間から15分間は予約不可時間となります。この時間を使って室内清掃や部屋の明け渡し準備などを行ってください。
            </dd>
          </div>
          <div>
            <dt>予約時間外は受付不可</dt>
            <dd>
              「{timeBlockBegin}時～{timeBlockEnd}
              時」の時間帯で予約できます。各部屋ごとのタイムテーブルには当日分の予約内容が反映されます。
            </dd>
          </div>
          <div>
            <dt>過去の予約内容は随時削除</dt>
          ...
          <div>
            ...
            <dd>
              使用後は室内清掃を行ってください。部屋内の棚にアルコールスプレーとタオルが置いてあります。
            </dd>
          </div>
        </dl>
      </div>
