    ...
    return (
        <>
            {days.map(day => {
                ...
                return (
                    <li key={key} className="w-full aspect-square">
                        {
                            isPast ? (
                            ...
                            <button
                                ...
                                className={`w-full h-full flex items-center justify-center rounded transition
                                ${isSelected ? "bg-gray-700 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-400"}
                                `}
                            >
                                {day.day}
                            </button>
